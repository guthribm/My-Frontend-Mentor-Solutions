...
**The social media icons were a little tricky for me. I used <code>filter: hue-rotate(0deg) saturate(226) contrast(0.5);</code> as a hover state change to achieve it.**
